        ...
        items.each(function () {
            ...
            var $this = $(this),
                config = {
					...
					'style_map'      : $this.data( 'style_map' ),
					'scrollwheel'    : $this.data( 'scrollwheel' ),
					'polyline'       : $this.data( 'polyline' ),
					'geodesic'       : $this.data( 'geodesic' ),
					'polylineStroke' : $this.data( 'polylineStroke' ),
					'polylineColor'  : $this.data( 'polylineColor' ),
					'draggable'      : $this.data( 'draggable' ),
					'disable_map_ui' : $this.data( 'disable_map_ui' )
				},
                map_options = {};
